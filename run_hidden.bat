@echo off
REM FSX Weather Bridge - Run Script (Background Mode)
REM This script starts the application in the background without a console window
REM All logs are written to files in the logs/ directory
...
REM Use VBScript wrapper to run without ANY console window
REM This prevents any console from appearing at all
cscript //nologo "%~dp0run_hidden.vbs"

REM Note: No pause here since console is hidden
